...
public class QueryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(QueryActivity.this, "Please Fill All The Details!!!", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    public void sendemail(String sub,String msg)
    {
        ...
        try {
            ...
            Toast.makeText(QueryActivity.this, "There is no email client installed.", Toast.LENGTH_SHORT).show();
        }
    }
}